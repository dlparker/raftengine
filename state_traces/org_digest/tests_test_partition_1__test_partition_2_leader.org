...
|  LEAD  |     | n=2   | CNDI  |                              |           | FLWR  | N-2->poll t=2 li=2 lt=2      |           |
|  LEAD  |     | n=2   | CNDI  |                              |           | FLWR  | vote->N-2 yes=True           | t=2       |
|  LEAD  |     | n=2   | CNDI  | N-3->vote yes=True           |           | FLWR  |                              |           |
|  LEAD  |     | n=2   | LEAD  | NEW ROLE                     | lt=2 li=3 | FLWR  |                              |           |
|  LEAD  |     | n=2   | LEAD  | ae->N-3 t=2 i=2 lt=1 e=1 c=2 |           | FLWR  |                              |           |
|  LEAD  |     | n=2   | LEAD  |                              |           | FLWR  | N-2->ae t=2 i=2 lt=1 e=1 c=2 |           |
|  LEAD  |     | n=2   | LEAD  |                              |           | FLWR  | ae_reply->N-2 ok=True mi=3   | lt=2 li=3 |
|  LEAD  |     | n=2   | LEAD  | N-3->ae_reply ok=True mi=3   |           | FLWR  |                              |           |
------------------------------------------------------------------------------------------------------------------------------
...
|  LEAD  |     | n=2   | LEAD  |                              |       | FLWR  | N-2->ae t=2 i=3 lt=2 e=1 c=3 |       |
|  LEAD  |     | n=2   | LEAD  |                              |       | FLWR  | ae_reply->N-2 ok=True mi=4   | li=4  |
|  LEAD  |     | n=2   | LEAD  | N-3->ae_reply ok=True mi=4   |       | FLWR  |                              |       |
|  LEAD  |     | n=2   | LEAD  |                              | ci=4  | FLWR  | N-2->ae t=2 i=4 lt=2 e=0 c=4 |       |
|  LEAD  |     | n=2   | LEAD  | CMD DONE                     |       | FLWR  |                              | ci=4  |
...
|  LEAD  | N-2->ae_reply ok=False mi=4  |       | LEAD  |                              |       | FLWR  |                              |       |
|  FLWR  | NEW ROLE                     | t=2   | LEAD  |                              |       | FLWR  |                              |       |
...
|  FLWR  | N-2->ae t=2 i=2 lt=1 e=1 c=4 |                | LEAD  |                              |       | FLWR  |                              |       |
|  FLWR  | ae_reply->N-2 ok=True mi=3   | lt=2 li=3 ci=3 | LEAD  |                              |       | FLWR  |                              |       |
...
|  FLWR  | ae_reply->N-2 ok=True mi=4   | li=4 ci=4      | LEAD  |                              |       | FLWR  |                              |       |
