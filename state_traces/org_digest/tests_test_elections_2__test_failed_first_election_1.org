...
|  CNDI  | p_v_r->N-2 t=1 li=0 lt=1     |           | FLWR  |                              |           | FLWR  |                              |           |
|  CNDI  | p_v_r->N-3 t=1 li=0 lt=1     |           | FLWR  |                              |           | FLWR  |                              |           |
|  CNDI  |                              |           | FLWR  | N-3->ae t=1 i=0 lt=0 e=1 c=0 | lt=1 li=1 | FLWR  |                              |           |
|  CNDI  |                              |           | FLWR  | ae_reply->N-3 ok=True mi=1   |           | FLWR  |                              |           |
|  CNDI  |                              |           | FLWR  | N-1->p_v_r t=1 li=0 lt=1     |           | FLWR  |                              |           |
...
|  LEAD  |                              |           | FLWR  | N-1->ae t=2 i=0 lt=0 e=1 c=0 | lt=2      | FLWR  |                              |           |
