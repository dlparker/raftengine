...
|  FLWR  |                              |           | LEAD  | poll->N-3 t=2 li=1 lt=2      |           | CNDI  |                              |           |
...
|  FLWR  | N-2->ae t=2 i=1 lt=1 e=1 c=0 |           | LEAD  |                              |           | CNDI  |                              |           |
|  FLWR  | ae_reply->N-2 ok=True mi=2   | lt=2 li=2 | LEAD  |                              |           | CNDI  |                              |           |
|  FLWR  |                              |           | LEAD  | N-3->vote yes=False          |           | CNDI  |                              |           |
...
|  FLWR  |                              |           | LEAD  | vote->N-3 yes=False          | ci=2      | FLWR  |                              |           |
