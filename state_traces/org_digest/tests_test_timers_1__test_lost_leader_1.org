* Test test_lost_leader_1 from file tests/test_timers_1.py
...
|  CNDI  |                              |           | FLWR  | N-1->poll t=2 li=1 lt=2      | t=2       | FLWR  |                              |           |
|  CNDI  |                              |           | FLWR  | vote->N-1 yes=True           |           | FLWR  |                              |           |
|  LEAD  | N-2->vote yes=True           | lt=2 li=2 | FLWR  |                              |           | FLWR  |                              |           |
|  LEAD  | NEW ROLE                     |           | FLWR  |                              |           | FLWR  |                              |           |
|  LEAD  | poll->N-3 t=2 li=1 lt=2      |           | FLWR  |                              |           | FLWR  |                              |           |
|  LEAD  |                              |           | FLWR  |                              |           | FLWR  | N-1->poll t=2 li=1 lt=2      | t=2       |
...
|  LEAD  | ae->N-3 t=2 i=1 lt=1 e=1 c=0 |           | FLWR  |                              |           | FLWR  |                              |           |
