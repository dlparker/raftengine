* Test test_reelection_1 from file tests/test_elections_1.py
...
|  LEAD  |                              |           | FLWR  |                              |           | FLWR  | N-1->poll t=1 li=0 lt=1      |           |
|  LEAD  |                              |           | FLWR  |                              |           | FLWR  | vote->N-1 yes=True           | t=1       |
...
|  LEAD  | ae->N-3 t=1 i=0 lt=0 e=1 c=0 | ci=1      | FLWR  |                              |           | FLWR  |                              |           |
