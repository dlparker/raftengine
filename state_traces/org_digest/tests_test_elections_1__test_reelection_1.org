...
|  FLWR  |                              |           | CNDI  | p_v_r->N-1 t=1 li=1 lt=1     |           | FLWR  |                              |           |
|  FLWR  | N-2->p_v_r t=1 li=1 lt=1     |           | CNDI  |                              |           | FLWR  |                              |           |
|  FLWR  | p_v->N-2 yes=True            |           | CNDI  |                              |           | FLWR  |                              |           |
|  FLWR  |                              |           | CNDI  | N-1->p_v yes=True            | t=2       | FLWR  |                              |           |
|  FLWR  |                              |           | CNDI  | p_v_r->N-3 t=1 li=1 lt=1     |           | FLWR  |                              |           |
|  FLWR  |                              |           | CNDI  |                              |           | FLWR  | N-2->p_v_r t=1 li=1 lt=1     |           |
