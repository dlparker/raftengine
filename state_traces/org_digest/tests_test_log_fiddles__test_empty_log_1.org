...
|  FLWR  |                                 |                    | FLWR  |                                |            | CNDI  | p_v_r->N-1 t=1 li=23 lt=1       |            |
|  FLWR  |                                 |                    | FLWR  |                                |            | CNDI  | p_v_r->N-2 t=1 li=23 lt=1       |            |
|  FLWR  |                                 |                    | FLWR  | N-3->p_v_r t=1 li=23 lt=1      |            | CNDI  |                                 |            |
|  FLWR  |                                 |                    | FLWR  | p_v->N-3 yes=True              |            | CNDI  |                                 |            |
|  FLWR  |                                 |                    | FLWR  |                                |            | CNDI  | N-2->p_v yes=True               | t=2        |
|  FLWR  |                                 |                    | FLWR  |                                |            | CNDI  | poll->N-1 t=2 li=23 lt=2        |            |
