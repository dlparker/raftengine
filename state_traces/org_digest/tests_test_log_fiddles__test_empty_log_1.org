...
|  FLWR  |                                 |                    | CNDI  | p_v_r->N-1 t=3 li=23 lt=2      |            | CNDI  |                                 |            |
|  FLWR  |                                 |                    | CNDI  | p_v_r->N-3 t=3 li=23 lt=2      |            | CNDI  |                                 |            |
|  FLWR  |                                 |                    | CNDI  |                                |            | CNDI  | N-2->p_v_r t=3 li=23 lt=2       |            |
|  FLWR  |                                 |                    | CNDI  |                                |            | CNDI  | p_v->N-2 yes=True               |            |
|  FLWR  |                                 |                    | CNDI  | N-3->p_v yes=True              | t=3        | CNDI  |                                 |            |
|  FLWR  |                                 |                    | CNDI  | poll->N-1 t=3 li=23 lt=3       |            | CNDI  |                                 |            |
|  FLWR  |                                 |                    | CNDI  | poll->N-3 t=3 li=23 lt=3       |            | CNDI  |                                 |            |
|  FLWR  |                                 |                    | CNDI  |                                |            | FLWR  | N-2->poll t=3 li=23 lt=3        | t=3        |
|  FLWR  |                                 |                    | CNDI  |                                |            | FLWR  | NEW ROLE                        |            |
|  FLWR  |                                 |                    | CNDI  |                                |            | FLWR  | vote->N-2 yes=False             |            |
|  FLWR  |                                 |                    | CNDI  | N-3->vote yes=False            |            | FLWR  |                                 |            |
|  FLWR  |                                 |                    | CNDI  |                                |            | CNDI  | p_v_r->N-1 t=4 li=23 lt=3       |            |
|  FLWR  |                                 |                    | CNDI  |                                |            | CNDI  | p_v_r->N-2 t=4 li=23 lt=3       |            |
|  FLWR  |                                 |                    | CNDI  | N-3->p_v_r t=4 li=23 lt=3      |            | CNDI  |                                 |            |
|  FLWR  |                                 |                    | CNDI  | p_v->N-3 yes=True              |            | CNDI  |                                 |            |
|  FLWR  |                                 |                    | CNDI  |                                |            | CNDI  | N-2->p_v yes=True               | t=4        |
|  FLWR  |                                 |                    | CNDI  |                                |            | CNDI  | poll->N-1 t=4 li=23 lt=4        |            |
|  FLWR  |                                 |                    | CNDI  |                                |            | CNDI  | poll->N-2 t=4 li=23 lt=4        |            |
|  FLWR  |                                 |                    | FLWR  | N-3->poll t=4 li=23 lt=4       | t=4        | CNDI  |                                 |            |
|  FLWR  |                                 |                    | FLWR  | NEW ROLE                       |            | CNDI  |                                 |            |
|  FLWR  |                                 |                    | FLWR  | vote->N-3 yes=False            |            | CNDI  |                                 |            |
|  FLWR  |                                 |                    | FLWR  |                                |            | CNDI  | N-2->vote yes=False             |            |
|  FLWR  |                                 |                    | FLWR  |                                |            | CNDI  | p_v_r->N-1 t=5 li=23 lt=4       |            |
|  FLWR  |                                 |                    | FLWR  |                                |            | CNDI  | p_v_r->N-2 t=5 li=23 lt=4       |            |
|  FLWR  |                                 |                    | FLWR  | N-3->p_v_r t=5 li=23 lt=4      |            | CNDI  |                                 |            |
|  FLWR  |                                 |                    | FLWR  | p_v->N-3 yes=True              |            | CNDI  |                                 |            |
|  FLWR  |                                 |                    | FLWR  |                                |            | CNDI  | N-2->p_v yes=True               | t=5        |
|  FLWR  |                                 |                    | FLWR  |                                |            | CNDI  | poll->N-1 t=5 li=23 lt=5        |            |
|  FLWR  |                                 |                    | FLWR  |                                |            | CNDI  | poll->N-2 t=5 li=23 lt=5        |            |
|  FLWR  |                                 |                    | FLWR  | N-3->poll t=5 li=23 lt=5       | t=5        | CNDI  |                                 |            |
|  FLWR  |                                 |                    | FLWR  | vote->N-3 yes=True             |            | CNDI  |                                 |            |
|  FLWR  |                                 |                    | FLWR  |                                |            | LEAD  | N-2->vote yes=True              | lt=5 li=24 |
|  FLWR  |                                 |                    | FLWR  |                                |            | LEAD  | NEW ROLE                        |            |
|  FLWR  |                                 |                    | FLWR  |                                |            | LEAD  | ae->N-1 t=5 i=23 lt=1 e=1 c=23  |            |
|  FLWR  |                                 |                    | FLWR  |                                |            | LEAD  | ae->N-2 t=5 i=23 lt=1 e=1 c=23  |            |
|  FLWR  |                                 |                    | FLWR  | N-3->ae t=5 i=23 lt=1 e=1 c=23 | lt=5 li=24 | LEAD  |                                 |            |
...
|  FLWR  |                                 |                    | FLWR  |                                |            | LEAD  | ae->N-1 t=5 i=24 lt=5 e=0 c=24  |            |
|  FLWR  | N-3->ae t=5 i=24 lt=5 e=0 c=24  | t=5                | FLWR  |                                |            | LEAD  |                                 |            |
|  FLWR  | ae_reply->N-3 ok=False mi=0     |                    | FLWR  |                                |            | LEAD  |                                 |            |
|  FLWR  |                                 |                    | FLWR  |                                |            | LEAD  | N-1->ae_reply ok=False mi=0     |            |
|  FLWR  |                                 |                    | FLWR  |                                |            | LEAD  | ae->N-2 t=5 i=24 lt=5 e=0 c=24  |            |
|  FLWR  |                                 |                    | FLWR  | N-3->ae t=5 i=24 lt=5 e=0 c=24 | ci=24      | LEAD  |                                 |            |
|  FLWR  |                                 |                    | FLWR  | ae_reply->N-3 ok=True mi=24    |            | LEAD  |                                 |            |
|  FLWR  |                                 |                    | FLWR  |                                |            | LEAD  | N-2->ae_reply ok=True mi=24     |            |
|  FLWR  |                                 |                    | FLWR  |                                |            | LEAD  | ae->N-1 t=5 i=0 lt=0 e=1 c=24   |            |
|  FLWR  | N-3->ae t=5 i=0 lt=0 e=1 c=24   | lt=1 li=1 ci=1     | FLWR  |                                |            | LEAD  |                                 |            |
|  FLWR  | ae_reply->N-3 ok=True mi=1      |                    | FLWR  |                                |            | LEAD  |                                 |            |
|  FLWR  |                                 |                    | FLWR  |                                |            | LEAD  | N-1->ae_reply ok=True mi=1      |            |
|  FLWR  |                                 |                    | FLWR  |                                |            | LEAD  | ae->N-1 t=5 i=1 lt=1 e=11 c=24  |            |
|  FLWR  | N-3->ae t=5 i=1 lt=1 e=11 c=24  | li=12 ci=12        | FLWR  |                                |            | LEAD  |                                 |            |
|  FLWR  | ae_reply->N-3 ok=True mi=12     |                    | FLWR  |                                |            | LEAD  |                                 |            |
|  FLWR  |                                 |                    | FLWR  |                                |            | LEAD  | N-1->ae_reply ok=True mi=12     |            |
|  FLWR  |                                 |                    | FLWR  |                                |            | LEAD  | ae->N-1 t=5 i=12 lt=1 e=11 c=24 |            |
|  FLWR  | N-3->ae t=5 i=12 lt=1 e=11 c=24 | li=23 ci=23        | FLWR  |                                |            | LEAD  |                                 |            |
|  FLWR  | ae_reply->N-3 ok=True mi=23     |                    | FLWR  |                                |            | LEAD  |                                 |            |
|  FLWR  |                                 |                    | FLWR  |                                |            | LEAD  | N-1->ae_reply ok=True mi=23     |            |
|  FLWR  |                                 |                    | FLWR  |                                |            | LEAD  | ae->N-1 t=5 i=23 lt=1 e=1 c=24  |            |
|  FLWR  | N-3->ae t=5 i=23 lt=1 e=1 c=24  | lt=5 li=24 ci=24   | FLWR  |                                |            | LEAD  |                                 |            |
