* Test test_command_after_heal_1 from file tests/test_commands_1.py
...
|  LEAD  | N-2->poll t=2 li=1 lt=2      |           | CNDI  |                              |           | FLWR  |                              |           |
|  FLWR  | NEW ROLE                     | t=2       | CNDI  |                              |           | FLWR  |                              |           |
|  FLWR  | ae->N-3 t=1 i=1 lt=1 e=0 c=1 |           | CNDI  |                              |           | FLWR  |                              |           |
|  FLWR  |                              |           | CNDI  | poll->N-3 t=2 li=1 lt=2      |           | FLWR  |                              |           |
|  FLWR  |                              |           | CNDI  |                              |           | FLWR  | N-1->ae t=1 i=1 lt=1 e=0 c=1 |           |
|  FLWR  |                              |           | CNDI  |                              |           | FLWR  | ae_reply->N-1 ok=True mi=1   | ci=1      |
...
|  FLWR  |                              |           | LEAD  | ae_reply->N-1 ok=False mi=1  |           | FLWR  |                              |           |
|  FLWR  |                              |           | LEAD  |                              |           | FLWR  | N-2->poll t=2 li=1 lt=2      |           |
|  FLWR  |                              |           | LEAD  |                              |           | FLWR  | vote->N-2 yes=True           | t=2       |
...
|  FLWR  |                              |           | LEAD  | ae->N-3 t=2 i=1 lt=1 e=1 c=0 | ci=2      | FLWR  |                              |           |
