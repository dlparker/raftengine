...
|  LEAD  |                              |       | FLWR  | p_v_r->N-1 t=1 li=1 lt=1     |       | FLWR  |                              |       |
|  LEAD  | N-2->p_v_r t=1 li=1 lt=1     |       | FLWR  |                              |       | FLWR  |                              |       |
|  LEAD  | ae->N-3 t=1 i=1 lt=1 e=0 c=1 |       | FLWR  |                              |       | FLWR  |                              |       |
|  LEAD  |                              |       | FLWR  | p_v_r->N-3 t=1 li=1 lt=1     |       | FLWR  |                              |       |
|  LEAD  |                              |       | FLWR  |                              |       | FLWR  | N-1->ae t=1 i=1 lt=1 e=0 c=1 | ci=1  |
|  LEAD  |                              |       | FLWR  |                              |       | FLWR  | ae_reply->N-1 ok=True mi=1   |       |
|  LEAD  | N-3->ae_reply ok=True mi=1   |       | FLWR  |                              |       | FLWR  |                              |       |
|  LEAD  | p_v->N-2 yes=True            |       | FLWR  |                              |       | FLWR  |                              |       |
|  LEAD  |                              |       | FLWR  | N-1->p_v yes=True            |       | FLWR  |                              |       |
|  LEAD  |                              |       | FLWR  | ae_reply->N-1 ok=True mi=1   |       | FLWR  |                              |       |
|  LEAD  |                              |       | FLWR  |                              |       | FLWR  | N-2->p_v_r t=1 li=1 lt=1     |       |
|  LEAD  |                              |       | FLWR  |                              |       | FLWR  | p_v->N-2 yes=True            |       |
|  LEAD  | N-2->ae_reply ok=True mi=1   |       | FLWR  |                              |       | FLWR  |                              |       |
|  LEAD  |                              |       | FLWR  | N-3->p_v yes=True            |       | FLWR  |                              |       |
-----------------------------------------------------------------------------------------------------------------------------------------------
