...
|  FLWR  |                          |       | CNDI  | N-1->p_v yes=True        | t=2   | CNDI  |     |       |
--------------------------------------------------------------------------------------------------------------
** Letting node 1 get the request vote message from node 3, which should get a no response
--------------------------------------------------------------------------------------------------------------
|  N-1   | N-1                      | N-1   | N-2   | N-2 | N-2   | N-3   | N-3                      | N-3   |
|  Role  | Op                       | Delta | Role  | Op  | Delta | Role  | Op                       | Delta |
|  FLWR  |                          |       | CNDI  |     |       | CNDI  | p_v_r->N-1 t=1 li=1 lt=1 |       |
|  FLWR  |                          |       | CNDI  |     |       | CNDI  | p_v_r->N-2 t=1 li=1 lt=1 |       |
|  FLWR  | N-3->p_v_r t=1 li=1 lt=1 |       | CNDI  |     |       | CNDI  |                          |       |
|  FLWR  | vote->N-3 yes=False      |       | CNDI  |     |       | CNDI  |                          |       |
|  FLWR  |                          |       | CNDI  |     |       | CNDI  | N-2->p_v_r t=1 li=1 lt=1 |       |
--------------------------------------------------------------------------------------------------------------
