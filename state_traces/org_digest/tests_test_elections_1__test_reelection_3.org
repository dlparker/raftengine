...
|  CNDI  | p_v_r->N-2 t=1 li=1 lt=1     |           | CNDI  |                              |           | CNDI  |                              |           |
|  CNDI  |                              |           | CNDI  | N-1->p_v_r t=1 li=1 lt=1     |           | CNDI  |                              |           |
|  CNDI  |                              |           | CNDI  | p_v_r->N-1 t=1 li=1 lt=1     |           | CNDI  |                              |           |
|  CNDI  |                              |           | CNDI  |                              |           | CNDI  | p_v_r->N-1 t=1 li=1 lt=1     |           |
|  CNDI  | N-2->p_v_r t=1 li=1 lt=1     |           | CNDI  |                              |           | CNDI  |                              |           |
|  CNDI  | p_v_r->N-3 t=1 li=1 lt=1     |           | CNDI  |                              |           | CNDI  |                              |           |
|  CNDI  |                              |           | CNDI  | p_v_r->N-3 t=1 li=1 lt=1     |           | CNDI  |                              |           |
|  CNDI  |                              |           | CNDI  |                              |           | CNDI  | N-1->p_v_r t=1 li=1 lt=1     |           |
|  CNDI  |                              |           | CNDI  |                              |           | CNDI  | p_v_r->N-2 t=1 li=1 lt=1     |           |
|  CNDI  | N-3->p_v_r t=1 li=1 lt=1     |           | CNDI  |                              |           | CNDI  |                              |           |
|  CNDI  | p_v->N-2 yes=True            |           | CNDI  |                              |           | CNDI  |                              |           |
|  CNDI  |                              |           | CNDI  | N-3->p_v_r t=1 li=1 lt=1     |           | CNDI  |                              |           |
|  CNDI  |                              |           | CNDI  | p_v->N-1 yes=True            |           | CNDI  |                              |           |
|  CNDI  |                              |           | CNDI  |                              |           | CNDI  | N-2->p_v_r t=1 li=1 lt=1     |           |
...
|  CNDI  |                              |           | CNDI  |                              |           | FLWR  | N-1->poll t=2 li=1 lt=2      | t=2       |
|  CNDI  |                              |           | CNDI  |                              |           | FLWR  | NEW ROLE                     |           |
|  CNDI  |                              |           | CNDI  |                              |           | FLWR  | vote->N-1 yes=True           |           |
|  CNDI  | N-2->poll t=2 li=1 lt=2      |           | CNDI  |                              |           | FLWR  |                              |           |
|  CNDI  | vote->N-2 yes=False          |           | CNDI  |                              |           | FLWR  |                              |           |
|  CNDI  |                              |           | CNDI  | N-1->vote yes=False          |           | FLWR  |                              |           |
|  CNDI  |                              |           | CNDI  | vote->N-1 yes=False          |           | FLWR  |                              |           |
|  CNDI  |                              |           | CNDI  |                              |           | FLWR  | N-2->poll t=2 li=1 lt=2      |           |
|  CNDI  |                              |           | CNDI  |                              |           | FLWR  | vote->N-2 yes=False          |           |
|  LEAD  | N-3->vote yes=True           | lt=2 li=2 | CNDI  |                              |           | FLWR  |                              |           |
|  LEAD  | NEW ROLE                     |           | CNDI  |                              |           | FLWR  |                              |           |
...
|  LEAD  |                              |           | FLWR  | N-1->ae t=2 i=1 lt=1 e=1 c=0 | lt=2 li=2 | FLWR  |                              |           |
|  LEAD  |                              |           | FLWR  | NEW ROLE                     |           | FLWR  |                              |           |
|  LEAD  |                              |           | FLWR  | ae_reply->N-1 ok=True mi=2   |           | FLWR  |                              |           |
|  LEAD  |                              |           | FLWR  |                              |           | FLWR  | N-1->ae t=2 i=1 lt=1 e=1 c=0 | lt=2 li=2 |
|  LEAD  |                              |           | FLWR  |                              |           | FLWR  | ae_reply->N-1 ok=True mi=2   |           |
|  LEAD  | N-2->ae_reply ok=True mi=2   | ci=2      | FLWR  |                              |           | FLWR  |                              |           |
|  LEAD  | N-3->ae_reply ok=True mi=2   |           | FLWR  |                              |           | FLWR  |                              |           |
|  LEAD  |                              |           | CNDI  | p_v_r->N-1 t=2 li=2 lt=2     |           | FLWR  |                              |           |
|  LEAD  | N-2->p_v_r t=2 li=2 lt=2     |           | CNDI  |                              |           | FLWR  |                              |           |
|  LEAD  | p_v->N-2 yes=True            |           | CNDI  |                              |           | FLWR  |                              |           |
|  LEAD  |                              |           | CNDI  | N-1->p_v yes=True            | t=3       | FLWR  |                              |           |
|  LEAD  |                              |           | CNDI  | p_v_r->N-3 t=2 li=2 lt=2     |           | FLWR  |                              |           |
|  LEAD  |                              |           | CNDI  |                              |           | FLWR  | N-2->p_v_r t=2 li=2 lt=2     |           |
|  LEAD  |                              |           | CNDI  |                              |           | FLWR  | p_v->N-2 yes=True            |           |
|  LEAD  |                              |           | CNDI  | N-3->p_v yes=True            |           | FLWR  |                              |           |
|  LEAD  |                              |           | CNDI  | poll->N-1 t=3 li=2 lt=3      |           | FLWR  |                              |           |
|  FLWR  | N-2->poll t=3 li=2 lt=3      | t=3       | CNDI  |                              |           | FLWR  |                              |           |
|  FLWR  | NEW ROLE                     |           | CNDI  |                              |           | FLWR  |                              |           |
|  FLWR  | vote->N-2 yes=False          |           | CNDI  |                              |           | FLWR  |                              |           |
|  FLWR  |                              |           | CNDI  | N-1->vote yes=False          |           | FLWR  |                              |           |
|  FLWR  |                              |           | CNDI  | poll->N-3 t=3 li=2 lt=3      |           | FLWR  |                              |           |
|  FLWR  |                              |           | CNDI  |                              |           | FLWR  | N-2->poll t=3 li=2 lt=3      | t=3       |
|  FLWR  |                              |           | CNDI  |                              |           | FLWR  | vote->N-2 yes=True           |           |
|  FLWR  |                              |           | LEAD  | N-3->vote yes=True           | lt=3 li=3 | FLWR  |                              |           |
|  FLWR  |                              |           | LEAD  | NEW ROLE                     |           | FLWR  |                              |           |
|  FLWR  |                              |           | LEAD  | ae->N-1 t=3 i=2 lt=2 e=1 c=0 |           | FLWR  |                              |           |
|  FLWR  | N-2->ae t=3 i=2 lt=2 e=1 c=0 | lt=3 li=3 | LEAD  |                              |           | FLWR  |                              |           |
|  FLWR  | ae_reply->N-2 ok=True mi=3   |           | LEAD  |                              |           | FLWR  |                              |           |
|  FLWR  |                              |           | LEAD  | N-1->ae_reply ok=True mi=3   | ci=3      | FLWR  |                              |           |
|  FLWR  |                              |           | LEAD  | ae->N-3 t=3 i=2 lt=2 e=1 c=0 |           | FLWR  |                              |           |
|  FLWR  |                              |           | LEAD  |                              |           | FLWR  | N-2->ae t=3 i=2 lt=2 e=1 c=0 | lt=3 li=3 |
