* Test test_election_timeout_1 from file tests/test_elections_2.py
...
|  FLWR  |                              |           | CNDI  | poll->N-1 t=2 li=1 lt=2      |           | CNDI  |                              | t=2       |
|  FLWR  |                              |           | CNDI  | poll->N-3 t=2 li=1 lt=2      |           | CNDI  |                              |           |
|  FLWR  |                              |           | CNDI  |                              |           | CNDI  | poll->N-1 t=2 li=1 lt=2      |           |
|  FLWR  |                              |           | CNDI  |                              |           | CNDI  | poll->N-2 t=2 li=1 lt=2      |           |
|  FLWR  |                              |           | CNDI  |                              |           | CNDI  | N-2->poll t=2 li=1 lt=2      |           |
|  FLWR  |                              |           | CNDI  |                              |           | CNDI  | vote->N-2 yes=False          |           |
|  FLWR  | N-2->poll t=2 li=1 lt=2      |           | CNDI  |                              |           | CNDI  |                              |           |
|  FLWR  | vote->N-2 yes=True           | t=2       | CNDI  |                              |           | CNDI  |                              |           |
|  FLWR  | N-3->poll t=2 li=1 lt=2      |           | CNDI  |                              |           | CNDI  |                              |           |
|  FLWR  | vote->N-3 yes=False          |           | CNDI  |                              |           | CNDI  |                              |           |
|  FLWR  |                              |           | CNDI  | N-3->poll t=2 li=1 lt=2      |           | CNDI  |                              |           |
|  FLWR  |                              |           | CNDI  | vote->N-3 yes=False          |           | CNDI  |                              |           |
|  FLWR  |                              |           | CNDI  | N-3->vote yes=False          |           | CNDI  |                              |           |
...
|  FLWR  |                              |           | LEAD  |                              |           | CNDI  | N-2->vote yes=False          |           |
