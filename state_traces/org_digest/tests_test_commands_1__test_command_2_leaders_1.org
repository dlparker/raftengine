...
|  LEAD  |     |       | CNDI  |                              |           | FLWR  | N-2->poll t=2 li=2 lt=2      |           |
|  LEAD  |     |       | CNDI  |                              |           | FLWR  | vote->N-2 yes=True           | t=2       |
|  LEAD  |     |       | CNDI  | N-3->vote yes=True           |           | FLWR  |                              |           |
|  LEAD  |     |       | LEAD  | NEW ROLE                     | lt=2 li=3 | FLWR  |                              |           |
|  LEAD  |     |       | LEAD  | ae->N-1 t=2 i=2 lt=1 e=1 c=2 |           | FLWR  |                              |           |
|  LEAD  |     |       | LEAD  | ae->N-3 t=2 i=2 lt=1 e=1 c=2 |           | FLWR  |                              |           |
|  LEAD  |     |       | LEAD  |                              |           | FLWR  | N-2->ae t=2 i=2 lt=1 e=1 c=2 |           |
|  LEAD  |     |       | LEAD  |                              |           | FLWR  | ae_reply->N-2 ok=True mi=3   | lt=2 li=3 |
|  LEAD  |     |       | LEAD  | N-3->ae_reply ok=True mi=3   |           | FLWR  |                              |           |
|  LEAD  |     |       | LEAD  | CMD START                    | ci=3      | FLWR  |                              |           |
|  LEAD  |     |       | LEAD  | ae->N-3 t=2 i=3 lt=2 e=1 c=3 | li=4      | FLWR  |                              |           |
|  LEAD  |     |       | LEAD  |                              |           | FLWR  | N-2->ae t=2 i=3 lt=2 e=1 c=3 |           |
|  LEAD  |     |       | LEAD  |                              |           | FLWR  | ae_reply->N-2 ok=True mi=4   | li=4      |
|  LEAD  |     |       | LEAD  | N-3->ae_reply ok=True mi=4   |           | FLWR  |                              |           |
|  LEAD  |     |       | LEAD  |                              | ci=4      | FLWR  | N-2->ae t=2 i=4 lt=2 e=0 c=4 |           |
|  LEAD  |     |       | LEAD  | CMD DONE                     |           | FLWR  |                              | ci=4      |
------------------------------------------------------------------------------------------------------------------------------
...
|  LEAD  | N-2->ae t=2 i=4 lt=2 e=0 c=4 |                | LEAD  |                              |       | FLWR  |                              |       |
