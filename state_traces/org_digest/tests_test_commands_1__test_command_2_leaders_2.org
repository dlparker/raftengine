* Test test_command_2_leaders_2 from file tests/test_commands_1.py
...
|  LEAD  | N-2->poll t=2 li=2 lt=2      |           | LEAD  |                              |       | FLWR  |                            |       |
...
|  FLWR  | N-2->ae t=2 i=2 lt=1 e=1 c=2 |           | LEAD  |                              |       | FLWR  |                            |       |
|  FLWR  | ae_reply->N-2 ok=True mi=3   | lt=2 li=3 | LEAD  |                              |       | FLWR  |                            |       |
