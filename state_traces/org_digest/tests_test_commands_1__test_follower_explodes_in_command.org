...
|  n-1  | LEAD  | 1    | n-2->ent_reply  ok=True mi=3     |                    | FLWR  | 1    |          | li=3               | FLWR  | 1    |          |                    |
|  n-1  | LEAD  | 1    | entries->n-3 li=2 lt=1 ec=1 ci=2 |                    | FLWR  | 1    |          |                    | FLWR  | 1    |          |                    |
|  n-1  | LEAD  | 1    | n-3->ent_reply  ok=True mi=3     |                    | FLWR  | 1    |          |                    | FLWR  | 1    |          | li=3               |
|  n-1  | LEAD  | 1    | CMD DONE                         | ci=3               | FLWR  | 1    |          |                    | FLWR  | 1    |          |                    |
|  n-1  | LEAD  | 1    | entries->n-2 li=3 lt=1 ec=0 ci=3 |                    | FLWR  | 1    |          |                    | FLWR  | 1    |          |                    |
|  n-1  | LEAD  | 1    | n-2->ent_reply  ok=True mi=3     |                    | FLWR  | 1    |          | ci=3               | FLWR  | 1    |          |                    |
|  n-1  | LEAD  | 1    | entries->n-3 li=3 lt=1 ec=0 ci=3 |                    | FLWR  | 1    |          |                    | FLWR  | 1    |          |                    |
